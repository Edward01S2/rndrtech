      ...
      <Menu id="navMenu" className={`${open ? 'block' : 'hidden md:block'}`}>
        <div className="relative h-full pt-16 pl-8 md:pt-0 md:pl-0">
          <div className="h-full flex flex-col md:flex-row">
            <Link to={'/projects'} activeClassName="text-black" css={navItem}>
              Projects
            </Link>
            <Link to={'/services'}  activeClassName="text-black" css={navItem}>
              Services
            </Link>
            <Link to={'/articles'}  activeClassName="text-black" css={navItem}>
              Articles
            </Link>
            <Link to={'/contact'}  activeClassName="text-black" css={navItem}>
              Contact
            </Link>
          </div>
        </div>
